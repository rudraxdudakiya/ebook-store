...
export default function Signup() {
    ...
    const validateField = (name, value) => {
        ...
        switch (name) {
            case "firstname":
                errors.firstname = value.trim() === "" ? "First Name is required" : value.trim().length < 3 ? "First Name must be more than 3 characters" : "";
                break;
            case "lastname":
                errors.lastname = value.trim() === "" ? "Last Name is required" : value.trim().length < 3 ? "Last Name must be more than 3 characters" : "";
                break;
            case "email":
...
<Container maxWidth="md" sx={{ height: '110vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
    <CssBaseline />
...
{/* <Grid container sx={{ height: '100%', boxShadow: 3, borderRadius: 3, overflow: 'hidden' }}>
                        {/* Left Section */}
                        <Grid
                            sx={{
                                display: 'flex',
                        ...
                        >
                            <Typography variant="h3" sx={{ fontWeight: 'bold', mb: 2 }}>Welcome Back!</Typography>
                            <Typography variant="h6" sx={{ mb: 4 }}>Sign up to explore our digital library.</Typography>
                            <img
                                src={logo}
                                alt="Illustration"
                            ...
                            <Typography variant="h6" sx={{ mb: 6 }}>Happy Reading !📖😊</Typography>
